package projects.practice_hospitalproject;

public class Practise_3_HospitalRunner {

    private static Practise_3_Hospital hpt1 = new Practise_3_Hospital();
    ...
    public static Practise_3_Doctor findDoctor(String actualCase) {
    ...
    public static Practise_3_Case findPatientCase(String actualCase) {
        Practise_3_Case patientCase = new Practise_3_Case();
    ...
    public static Practise_3_Patient findPatient(String title) {
